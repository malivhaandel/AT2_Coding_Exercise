 ...
 * 
 * added star rotation animation (frame-based)
 * removed black circle shape from corner
 */
...
function draw() { 
  ...
  // fixed stars (position fixed, size varied, rotation animated)
  ...
  // right column (fully justified text)
  drawJustifiedText(
    contentB,
...
// star shape function (rotated decorative element)
